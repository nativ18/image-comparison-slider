...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const titleText = [
     ...
     const descriptionText = [
        ...
        "טיפול פיסול ועיבוי שפתיים מעניק לך מראה טבעי, מלא ורענן, המדגיש את היופי הייחודי שלך. התוצאה היא שפתיים מעוצבות ומלאות יותר, תוך שמירה על פרופורציות מאוזנות שמתאימות למבנה הפנים שלך. הטיפול מאפשר להבליט את קווי המתאר של השפתיים, לתקן אסימטריה עדינה, ולהחזיר נפח שאבד עם הזמן. לאחר הטיפול תיהני ממראה שפתיים רכות וחושניות המשדרות ביטחון ונשיות, עם מגע עדין של רעננות. חשוב לציין שהתוצאה מותאמת אישית על ידי ד"ר שרון רשיש, כדי להבטיח שהמראה ירגיש לך טבעי והרמוני."
    ];
