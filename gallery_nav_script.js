...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const descriptionText = [
        "טיפול טשטוש קמטים כולל הזרקת חומרים אסתטיים כמו חומצה היאלורונית או בוטוקס להחלקת קמטים ושיפור מראה עור הפנים. הטיפול מתאים למגוון קמטים ונותן תוצאה טבעית ורעננה. התוצאות נשארות למשך מספר חודשים וניתן לחדש את הטיפול לפי הצורך. טיפול טשטוש קמטים בעיניים מיועד להפחתת הקמטים הדקים והקווים שמופיעים סביב העיניים, כגון רגלי עורב
        . בעזרת הזרקות חומרים כמו חומצה היאלורונית או בוטוקס, אנו מספקים פתרון עדין וממוקד להחלקת הקמטים ולהחזרת המראה הצעיר והרענן לעור סביב העיניים. התוצאה היא מראה חלק וצעיר יותר, עם שיפור במרקם עור העפעפיים והסביבה."
    ];
